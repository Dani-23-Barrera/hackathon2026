...
# =========================
# TEXTO CON WRAP (CORRECCIÓN)
# =========================
def draw_text_box(surface, text_list, font, color, rect, line_height=38):
    y = rect.top + 20
    ...
    for line in text_list:
        ...
        for word in words:
            ...
            if test_surface.get_width() > rect.width - 40:
                surface.blit(font.render(current_line, True, color), (rect.left + 20, y))
                y += line_height
                current_line = word + " "
            else:
    ...
    # ================= TEORIA =================
        ...
        draw_text_box(
            ...
            [
                ...
                "i permet comunicar-se amb gestos humans.",
                "",
                "Aprendràs vocabulari bàsic d'una manera divertida",
                "mitjançant imatges i associacions."
            ],
            small_font,
            DARK,
            pygame.Rect(650, 180, 450, 300)
        )
