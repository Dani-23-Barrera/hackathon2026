...
while running:
    ...
    # ================= VICTORIA =================
        ...
        screen.blit(titol, titol.get_rect(center=(WIDTH//2, 250)))

        text = small_font.render("Has completat totes les parelles!", True, BLACK)
        screen.blit(text, text.get_rect(center=(WIDTH//2, 350)))

        text2 = small_font.render("Tornant al menú...", True, BLACK)
        screen.blit(text2, text2.get_rect(center=(WIDTH//2, 420)))
